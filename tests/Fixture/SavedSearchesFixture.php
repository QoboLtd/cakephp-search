...
class SavedSearchesFixture extends TestFixture
{
    ...
    public $records = [
        ...
        [
            ...
            'model' => 'search_users',
            'shared' => 'private',
            'content' => '{"criteria":{"name":[{"type":"string","operator":"contains","value":"user"}]},"aggregator":"OR","display_columns":["name"],"sort_by_field":"name","sort_by_order":"desc","limit":10}',
            'created' => '2016-07-01 10:39:23',
            'modified' => '2016-07-01 10:41:31',
            'trashed' => null,
        ],
