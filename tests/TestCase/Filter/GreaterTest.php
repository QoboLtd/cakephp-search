...
use Qobo\Search\Filter\Greater;
...
class GreaterTest extends TestCase
{
    ...
    {
        $filter = new Greater(new Field('title'), 'foo');
    ...
    {
        $filter = new Greater(new Field('title'), 'foo', new Aggregate(\Qobo\Search\Aggregate\Average::class), true);
